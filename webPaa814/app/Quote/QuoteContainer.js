    ...
    constructor(){
      ...
      this.state = {
          ...
          Basic: [
              ...
              {"id":"1","price":151.00,"status":"active"}
          ],
          Currency: [
              
              {"id":"1","price":47.43,"status":"active"}
          ],
          Routes: [
              
              {"id":"1","price":"123.00","shippingto":"Distrito Nacional","status":"active"}
          ],
          filterText: '',
          Approved: [],
          Pagination: '',
            ...
            <div>        
                <Quote quotes={this.state.Quotes}
                       ...
                       quoteCallbacks={{
                            ...
                            onViewQuote: this.onViewQuote.bind(this),
